...
if {[llength $uclk_freqs]} {
    ...
    create_generated_clock -name {uClk_usr} -source [get_pins {inst_fiu_top|inst_ccip_fabric_top|inst_cvl_top|inst_user_clk|qph_user_clk_fpll_u0|xcvr_fpll_a10_0|fpll_refclk_select_inst|refclk}] -duty_cycle 50/1 -multiply_by $uclk_freq_high -divide_by 1000 -master_clock {SYS_RefClk} [get_pins {inst_fiu_top|inst_ccip_fabric_top|inst_cvl_top|inst_user_clk|qph_user_clk_fpll_u0|xcvr_fpll_a10_0|fpll_inst|outclk[1]}] 
} else {
    # Default
